...
export default function ListenLinks() {
  ...
  const listenLinks = {
    ...
    googlePodcasts: "https://www.google.com/podcasts?feed=aHR0cHM6Ly9hbmNob3IuZm0vcy8yZGMwMmNjYy9wb2RjYXN0L3Jzcw==",
  ...
  return (
    <ListenLinksList>
      ...
      <a href={listenLinks['itunes']}><LinkLogo src={itunes} alt="logo" /></a>
      <a href={listenLinks['breaker']}><LinkLogo src={breaker} alt="logo" /></a>
      <a href={listenLinks['googlePodcasts']}><LinkLogo src={googlePodcasts} alt="logo" /></a>
      <a href={listenLinks['overcast']}><LinkLogo src={overcast} alt="logo" /></a>
      <a href={listenLinks['pocketCasts']}><LinkLogo src={pocketCasts} alt="logo" /></a>
      <a href={listenLinks['radioPublic']}><LinkLogo src={radioPublic} alt="logo" /></a>
      <a href={listenLinks['spotify']}><LinkLogo src={spotify} alt="logo" /></a>
    </ListenLinksList>
  );
}